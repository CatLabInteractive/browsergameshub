...
<p>To prevent identity theft and phishing, we have added a security check: your website, specified in the <site_url> tags, must contain an (invisible) link to your XML file.</p>
