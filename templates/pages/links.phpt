...
<ul>
	...
	<li><a href="http://terence.be/projects/dolumar" target="_BLANK">Terence</a> is working on a ranking site for PBBG players.</li>
</ul>

<p>Have you used our API to design a new website? Show us your creation at the <a href="<?=ABSOLUTE_URL?>forum/">Forum</a>.<br />
To get started quickly, take a look at out <a target="_BLANK" href="<?=ABSOLUTE_URL?>examples/updatescript.phps">example script</a> (PHP).</p>
